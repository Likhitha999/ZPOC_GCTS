...
TYPES: BEGIN OF ty_row,
         ...
         netwr   TYPE vbak-netwr,     " header value shown per item row
         waerk   TYPE vbak-waerk,
         faksp   TYPE vbap-faksp,     " billing block at item
         gbstk_h TYPE vbuk-gbstk,     " header overall status
         lfstk_h TYPE vbuk-lfstk,     " header delivery status
         fkstk_h TYPE vbuk-fkstk,     " header billing status
         iconrec TYPE icon_d,         " recent indicator
       END OF ty_row.
